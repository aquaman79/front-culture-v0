  ...
  films : Film[] = [
    {
        ...
        genre: "Documentaire",
        urlBandeAnnonce:"https://www.youtube.com/watch?v=42qhihfQ130&ab_channel=Merwan11b",
...
/*
  ...
  /* ngOnInit() {
   ...
   constructor(private filmService: FilmService, private panierService: PanierService,private sanitizer: DomSanitizer) {}
